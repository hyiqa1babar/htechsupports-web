/* src/components/SectorsSection.jsx
   Restores all 6 sector cards (Retail, Enterprise, Data Center, Carrier Network, Manufacturing, Government)
   in a 3x2 grid with teal-midnight backgrounds, teal-bright icons, and white text. */
...
const SECTOR_CARDS = [
  {
    ...
    description: 'Comprehensive site audits, IT health checks, and technology rollouts throughout retail estates.',
    link: '/pages/retail'
  },
  {
    id: 'enterprise',
    ...
    description: 'Unified collaboration upgrades across multiple corporate locations for global banking and enterprise networks.',
  ...
  },
  {
    ...
    description: 'Data center engineering services ranging from cable patching to full hardware deployment, racking, and support.',
    link: '/pages/data-center'
  },
  {
    id: 'carrier',
    ...
    description: 'Carrier-grade network rollouts, testing, and 24/7 maintenance across EMEA and APAC regions.',
    link: '/pages/carrier-network'
  },
  {
    id: 'manufacturing',
    title: 'Manufacturing',
    ...
    description: 'IT infrastructure, wireless optimization, and rapid technical support for manufacturing and logistics facilities.',
  ...
  },
  {
    ...
    description: 'Secure, compliant, BPSS-cleared IT solutions for government agencies and public sector organisations.',
    link: '/pages/government'
  },
];
        ...
        <div className="sectors-grid" role="list">
          {SECTOR_CARDS.map((sec) => (
            ...
            >
              ...
              <span className="sector-link-arrow" aria-hidden="true">→</span>
            </Link>
          ))}
        </div>
      </div>
